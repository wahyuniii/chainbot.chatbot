...
with tab1:
    ...
    st.write("Semua makhluk hidup membutuhkan energi untuk mempertahankan hidup. Bagaimana cara hewan dan tumbuhan untuk mendapatkan makanan sebagai sumber energi?")
    ...
    if submit:
        st.write("Hubungan makan dan dimakan antarmakhluk hidup untuk memperoleh energi dapat membentuk rantai makanan dan jaring-jaring makanan.")
        ...
        with tab4:
            ...
            st.write("Perhatikan gambar jaring-jaring makanan berikut!")
            ...
            st.write("Oleh karena itu, pada suatu ekosistem hubungan makan dan dimakan digambarkan dengan jaring-jaring makanan yang merupakan kumpulan dari rantai makanan.")
